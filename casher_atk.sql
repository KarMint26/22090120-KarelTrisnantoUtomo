...
-- Dumping data for table k_atk.tb_produk: ~8 rows (approximately)
REPLACE INTO `tb_produk` (`produk_id`, `nama_produk`, `harga_produk`, `stok_produk`) VALUES
	...
	('K0006', 'Rautan Pensil', 2000, 400),
	('K0007', 'Buku Gambar', 12000, 150),
	('K0008', 'Tipe X', 7000, 500);
...
-- Dumping data for table k_atk.tb_transaksi: ~56 rows (approximately)
REPLACE INTO `tb_transaksi` (`transaksi_id`, `tanggal_transaksi`, `jumlah_transaksi`) VALUES
	...
	('ID055', '2023-12-21', 50500),
	('ID056', '2023-12-21', 32500);
